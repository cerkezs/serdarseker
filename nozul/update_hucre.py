...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\hucre-tekeri.html'

with open(path, 'r', encoding='utf-8') as f:
    c = f.read()

# 1. Galeri HTML'i (7 Resim x 2 = 14 Slayt)
hucre_imgs = ["1.jpg", "2.jpeg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg"]
repeated_imgs = hucre_imgs * 2

slides_html = ""
for img in repeated_imgs:
    slides_html += f'      <div class="swiper-slide"><img src="../assets/images/hücretekeri/{img}" alt="Hücre Tekeri" onclick="openLightbox(this.src)"></div>\n'
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(c)
print("Hücre Tekeri Page Updated.")
