...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\klape.html'

with open(path, 'r', encoding='utf-8') as f:
    c = f.read()

# 1. Ana Resmi Değiştir (5.png yap)
# Mevcut resmi bul ve değiştir
c = re.sub(r'src="\.\./assets/images/.*?" alt="Klape"', r'src="../assets/images/klape/5.png" alt="Klape"', c)

# 2. Galeri HTML'i (5 Resim x 2 = 10 Slayt)
klape_imgs = ["1.png", "2.png", "3.png", "4.png", "5.png"]
repeated_imgs = klape_imgs * 2

slides_html = ""
for img in repeated_imgs:
    slides_html += f'      <div class="swiper-slide"><img src="../assets/images/klape/{img}" alt="Klape" onclick="openLightbox(this.src)"></div>\n'
