...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\surgu.html'

with open(path, 'r', encoding='utf-8') as f:
    c = f.read()

# 1. Ürün Adını Sadeleştir (Slide Gate yazısını kaldır)
c = c.replace('Sürgü (Slide Gate)', 'Sürgü')

# 2. Galeri HTML'i (5 Resim x 2 = 10 Slayt)
# Dosya isimleri list_dir'den: 1.jpg, 2.jpg, 3.png, 4.jpg, 5.png
surgu_imgs = ["1.jpg", "2.jpg", "3.png", "4.jpg", "5.png"]
repeated_imgs = surgu_imgs * 2

slides_html = ""
for img in repeated_imgs:
    slides_html += f'      <div class="swiper-slide"><img src="../assets/images/sürgü/{img}" alt="Sürgü" onclick="openLightbox(this.src)"></div>\n'
...
# 4. Hizalamalar (self-end) ve Card-Sweep
