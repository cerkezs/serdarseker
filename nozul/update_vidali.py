...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\vidali-konveyor.html'

with open(path, 'r', encoding='utf-8') as f:
    c = f.read()

# 1. Galeri HTML'i (8 Resim x 2 = 16 Slayt)
vidal_imgs = ["1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg"]
repeated_imgs = vidal_imgs * 2

slides_html = ""
for img in repeated_imgs:
    slides_html += f'      <div class="swiper-slide"><img src="../assets/images/vidalikonveyör/{img}" alt="Vidalı" onclick="openLightbox(this.src)"></div>\n'
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(c)
print("Vidalı Page Updated with Gallery.")
