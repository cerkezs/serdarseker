...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\kaucuk-bantli-konveyor.html'
...
<section class="py-6 bg-ink overflow-hidden">
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/1.jpg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/2.jpg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/3.png" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/4.jpg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/5.jpeg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/6.jpeg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/7.jpg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/kaucukkonveyör/8.jpeg" alt="Kauçuk" onclick="openLightbox(this.src)"></div>
    </div>
...
# 2. CSS, Swiper JS ve Lightbox (Head ve Body sonuna)
...
# 3. Hizalamalar (self-end) ve Card-Sweep
...
# Card-sweep kontrolü (Sadeleşmiş halini sweep ile güncelle)
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(c)
print("Kauçuk Page Updated with Gallery and Modern UI.")
