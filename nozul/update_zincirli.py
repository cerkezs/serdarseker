...
path = r'c:\Users\Serdarowski\Desktop\verisyon 2\urunler\zincirli-konveyor.html'

with open(path, 'r', encoding='utf-8') as f:
    c = f.read()

# 1. Galeri HTML'i (5 Resimli)
gallery_html = '''
...
<section class="py-6 bg-ink overflow-hidden">
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="../assets/images/zincirlikonveyör/1.jpg" alt="Zincirli" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/zincirlikonveyör/2.jpg" alt="Zincirli" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/zincirlikonveyör/3.jpg" alt="Zincirli" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/zincirlikonveyör/4.jpg" alt="Zincirli" onclick="openLightbox(this.src)"></div>
      <div class="swiper-slide"><img src="../assets/images/zincirlikonveyör/5.jpeg" alt="Zincirli" onclick="openLightbox(this.src)"></div>
    </div>
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(c)
print("Zincirli Page Fixed and Updated.")
